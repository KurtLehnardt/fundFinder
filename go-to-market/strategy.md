...
| 3 | **Buy-the-audience → but *organic* intermediaries** | 🟢 **Now** | $0 version: partner with funding intermediaries (TTOs, SBDCs, APEX Accelerators, EDOs, accelerators) who are chartered to hand founders a free funding tool. Leveraged distribution to exact-ICP founders. |
...
- **Output:** a 0–100 readiness grade + a per-dimension breakdown (✓ / ⚠ / ✗) + the single highest-leverage fix + **an honest verdict banner** (e.g. *"You're not registration-ready yet — fixing SAM.gov first will save you a rejection"*).
